...
public class _5_FindKNumberGreaterInBST {

    /**
     * 6.	There is a binary search tree with N numbers and a given number.
     * You need to find the first number in the tree that is strictly greater than this given number.
     * The given number itself may not be present in the tree. Should run in O(Log N).
